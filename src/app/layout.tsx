            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              {user ? (
                <Link
                  ...
                  title="Open profile"
                  className="inline-flex items-center gap-2 rounded-full border-[2.5px] border-ink bg-card p-1 text-sm font-bold transition-transform duration-150 hover:-translate-y-0.5 focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-[var(--pop)] active:translate-y-0 sm:px-3"
                ...
                >
                  ...
                  <span className="hidden text-xs font-medium opacity-60 sm:inline">
                    {user.classCode}
                  </span>
                </Link>
              ) : null}
