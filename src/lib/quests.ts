...
export const QUESTS: Quest[] = [
  ...
  },
  {
    ...
    artifact: "website",
    task:
      "SCENARIO: Your class is throwing an end-of-year party and the planning is chaos in the group chat. You need a sign-up website: people put their name down, say what food they're bringing, and everyone can see who's coming.\n\nYOUR TASK: Write the prompt that gets an agent to plan the right website. The agent will reply with a build brief, not generate the site. You do not need to know coding tools already: you may ask the agent to compare two beginner-friendly options, explain the tradeoffs in plain language, and wait for your choice. A useful prompt also covers what each sign-up remembers, what students and class reps may do, and what belongs in the first simple version.",
